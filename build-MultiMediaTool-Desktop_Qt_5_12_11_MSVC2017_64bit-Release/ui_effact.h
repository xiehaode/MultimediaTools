...
public:
    ...
    void setupUi(QWidget *effact)
    {
        ...
        addFile->setMinimumSize(QSize(100, 60));
        QIcon icon;
        ...
        exportFile->setMinimumSize(QSize(100, 60));
        QIcon icon1;
        ...
        sizePolicy3.setHeightForWidth(lineEdit_Path->sizePolicy().hasHeightForWidth());
        lineEdit_Path->setSizePolicy(sizePolicy3);
        ...
        sizePolicy5.setHeightForWidth(labelSrc->sizePolicy().hasHeightForWidth());
        labelSrc->setSizePolicy(sizePolicy5);
        ...
        sizePolicy6.setHeightForWidth(comboBoxSrc->sizePolicy().hasHeightForWidth());
        comboBoxSrc->setSizePolicy(sizePolicy6);
        ...
        sizePolicy7.setHeightForWidth(labelDst->sizePolicy().hasHeightForWidth());
        labelDst->setSizePolicy(sizePolicy7);
        ...
        sizePolicy6.setHeightForWidth(comboBoxDst->sizePolicy().hasHeightForWidth());
        comboBoxDst->setSizePolicy(sizePolicy6);
