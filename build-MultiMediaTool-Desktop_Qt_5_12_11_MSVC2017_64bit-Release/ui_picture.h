...
public:
    ...
    void setupUi(QWidget *picture)
    {
        ...
        verticalLayout_Right->setSizeConstraint(QLayout::SetMinAndMaxSize);
        ...
        verticalLayout_Right->addLayout(verticalLayout_2);
