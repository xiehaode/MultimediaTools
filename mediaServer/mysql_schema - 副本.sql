...
CREATE INDEX IF NOT EXISTS idx_commands_status_user ON ffmpeg_commands(status, user_id);
CREATE INDEX IF NOT EXISTS idx_sessions_token_user ON user_sessions(session_token, user_id);
